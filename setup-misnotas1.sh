...
echo "🚀 Creando proyecto misnotas1 con Vite + React..."
npm create vite@latest misnotas1 -- --template react
cd misnotas1
...
echo "⚛️ Escribiendo componente React principal (App.jsx)..."
cat > src/App.jsx <<'EOF'
...
echo "✅ Proyecto misnotas1 listo. Ejecuta:"
echo ""
echo "   cd misnotas1"
echo "   npm run dev"
